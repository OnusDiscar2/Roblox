if "KEY_ONUS" == _G.Key then
    
local colorSettings =
{
    ["Main"] = {
        ["HeaderColor"] = _G.Color,
        ["HeaderShadingColor"] = _G.Color2,
...
HeaderTextLabel.Text = "รีโมท สปาย TH"
...
Code.Text = "แปลไทยโดย Onus Discar"
...
CodeComment.Text = "Discord : https://discord.gg/HJmmRBdbJ6"
...
InfoHeaderText.Text = "รีโมทสปาย ภาษาไทยโดย : Onus Discar"
...
CopyScriptPath.Text = "คัดลอก สคริป path"
...
CopyDecompiled.Text = "คัดลอก decompiled สคริป"
...
IgnoreRemote.Text = "ไม่สนใจ remote"
...
BlockRemote.Text = "บล็อกรีโมทจากการยิง"
...
WhileLoop.Text = "สร้างในขณะที่ลูปสคริปต์"
...
CopyReturn.Text = "ดำเนินการและคัดลอกค่า"
...
DoNotStack.Text = "Unstack รีโมตเมื่อยิงด้วย args ใหม่"
